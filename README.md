...
| :- | :- |
|**Desenvolver um algoritmo para predição de queimadas no Pantanal, por meio dos datasets do Instituto Nacional de Pesquisas Espaciais (Inpe) e do Laboratório de Aplicações de Satélites Ambientais do Departamento de Meteorologia da UFRJ (LASA)**|*PROJ\_QUEIMA\_BR*|
